...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(input_size=embed_size, hidden_size=self.hidden_size, num_layers=1, bidirectional=True)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        attention_proj = self.att_projection(enc_hiddens)
        ...
        for Y_t in Y_T:
            ...
            dec_state, o_t, e_t = self.step(Y_bar_t, dec_state, enc_hiddens, attention_proj, enc_masks)
